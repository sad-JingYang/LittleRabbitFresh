...
import { FetchGoodsById } from '@/services/goods'
...
const goods = ref<GoodsResult>() // 商品详情信息数据
...
const popupName = ref<'address' | 'service'>() // 弹出层条件渲染

const isShowSku = ref(false) // 是否显示SKU组件

const localdata = ref({} as SkuPopupLocaldata) // 商品信息
...
<template>
  <scroll-view :scroll-y="true" class="viewport">
    ...
    <view class="goods">
      <!-- 商品主图 -->
      <view class="preview">
        <swiper :circular="true" @change="onChange">
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    <view class="icons">
      ...
      <navigator class="icons-button" url="/pages/cart/AlternateCart" open-type="navigate">
